...
export const queryCode = `query FullQuery{root{enableNewsletterSignups}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"enableNewsletterSignups":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const initData = {"commitId":39636,"hash":"4335835220537663","reducedExpression":{"id":"TYhYLPVf1Sndbudd2SA8v","logs":{},"type":"ObjectExpression","fields":{"root":{"id":"Dhak2jS-AFjQZW4yIV69l","body":{"id":"vKViYjCNSUeQaPpTUy15Y","logs":{},"type":"ObjectExpression","fields":{"enableNewsletterSignups":{"id":"CKDYQMRhreC5k31YYqO5Q","type":"BooleanExpression","value":false,"valueType":{"type":"BooleanValueType"},"logs":{"evaluations":{"duVs45vmUeXapEx0t9TSw":1}}}},"valueType":{"type":"ObjectValueType","objectTypeName":"Root"},"objectTypeName":"Root"},"logs":{},"type":"FunctionExpression","valueType":{"type":"FunctionValueType","returnValueType":{"type":"ObjectValueType","objectTypeName":"Root"},"parameterValueTypes":[{"type":"ObjectValueType","objectTypeName":"Query_root_args"}]},"parameters":[{"id":"PXvMHmUcb-OTC6wGtxW0M","name":"rootArgs"}]}},"metadata":{"permissions":{"user":{},"group":{"team":{"write":"allow"}}}},"valueType":{"type":"ObjectValueType","objectTypeName":"Query"},"objectTypeName":"Query"},"splits":{},"commitConfig":{"splitConfig":{}}}


export const vercelFlagDefinitions = {"enableNewsletterSignups":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/6890/main/draft/logic?selected_field_path=root%3EenableNewsletterSignups"}};

export type FlagValues = {
  "enableNewsletterSignups": boolean;
}

export type FlagPath = keyof FlagValues & string;

export const flagFallbacks: FlagValues = {
  "enableNewsletterSignups": false,
}
...
const rootFallback = {enableNewsletterSignups:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/6890/main/draft/logic?selected_field_path=root%3EenableNewsletterSignups})
   */
  enableNewsletterSignups({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("enableNewsletterSignups", { fieldArguments: args });
...
const sourceFallback = {root:{enableNewsletterSignups:false}};
